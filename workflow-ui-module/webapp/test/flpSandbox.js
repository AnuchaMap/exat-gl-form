		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "gl Approval Form",
									"targetURL": "#glmgtnspworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"glmgtnspworkflowuimodule-display": {
								"semanticObject": "glmgtnspworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=glmgtnsp.workflowuimodule",
									"url": sap.ui.require.toUrl("glmgtnsp/workflowuimodule")
								}
							}
						}
					}
